...
public class ThreadMensaje 
{
    ...
    public ThreadMensaje(String nombre_hilo) {
        super(nombre_hilo);
    }
    ...
    public void TimerCorreo
    {
        while(respuesta==true)
        {
                ...
                TimerTask tarea = new TimerTask() 
                {
                    ...
                    public void run() 
                    {
                        ...
                        else
                        {
                            ...
                            EnvioCorreos envio_correos = new EnvioCorreos(m_archivos,reu,mensaje);
                            envio_correos.EnviarCorreos();
                        }
                    }
                };
            ...
            {
                respuesta=false;
                System.out.println("Salir del bucle"+getName());
            }
        }
    }
